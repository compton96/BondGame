...
[CreateAssetMenu(fileName = "FragariaPetalSawAttack", menuName = "ScriptableObjects/BTSubtrees/Attacks/Fragaria/Petal Saw")]
public class FragariaPetalSawAttack : BTSubtree
{
    public override BTSequence BuildSequenceSubtree(CreatureAIContext context) 
    {
        ...
        #region if target already exists selector
         ...
         #region Approach and attack sequence
            ...
            CActionAttackPetalSaw petalSaw = new CActionAttackPetalSaw("Melee Attack", context);
            //MeleeApproachSequenceList.Add(checkIfDistanceToTarget);
            MeleeApproachSelectorList.Add(invertApproachForAttack);
            MeleeApproachSelectorList.Add(petalSaw);
